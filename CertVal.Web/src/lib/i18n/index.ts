...
export const translations = {
    uk: {
        ...
        workspaces: {
            ...
            auditLog: 'Журнал подій',
            auditLogTitle: 'Журнал подій робочого простору',
            auditLogEmpty: 'Поки що немає записів. Дії з’являтимуться тут.',
            auditLogBack: 'Назад до робочого простору',
            endpoints: 'Моніторинг хостів',
            epTitle: 'Моніторинг хостів',
            epSubtitle: 'CertVal періодично під’єднується до цих хостів і відстежує сертифікати, термін дії та оцінку TLS.',
            epAdd: 'Додати хост',
            epHost: 'Хост',
            epPort: 'Порт',
            epInterval: 'Інтервал (хв)',
            epEnabled: 'Увімкнено',
            epStatus: 'Статус',
            epGrade: 'Оцінка',
            epExpiry: 'Дійсний до',
            epLastChecked: 'Остання перевірка',
            epNever: 'ще не перевірявся',
            epReachable: 'Доступний',
            epUnreachable: 'Недоступний',
            epEmpty: 'Хости ще не додано. Додайте host:port, щоб почати моніторинг.',
            epDelete: 'Видалити',
            epSave: 'Зберегти',
            epCancel: 'Скасувати',
            epHostPlaceholder: 'example.com',
            epBack: 'Назад до робочого простору',
        ...
        certificates: {
            ...
            bulkSelect: 'Вибрати',
            bulkDone: 'Готово',
            bulkSelected: 'вибрано',
            bulkSkip: 'Не моніторити',
            bulkUnskip: 'Моніторити',
            bulkAddTag: 'Додати тег',
            bulkRemoveTag: 'Прибрати тег',
            bulkDelete: 'Видалити',
            bulkTagPlaceholder: 'тег',
    ...
    en: {
        ...
        workspaces: {
            ...
            auditLog: 'Audit log',
            auditLogTitle: 'Workspace audit log',
            auditLogEmpty: 'No activity yet. Actions will appear here.',
            auditLogBack: 'Back to workspace',
            endpoints: 'Endpoint monitoring',
            epTitle: 'Endpoint monitoring',
            epSubtitle: 'CertVal periodically connects to these hosts and tracks their certificate, expiry and TLS grade.',
            epAdd: 'Add endpoint',
            epHost: 'Host',
            epPort: 'Port',
            epInterval: 'Interval (min)',
            epEnabled: 'Enabled',
            epStatus: 'Status',
            epGrade: 'Grade',
            epExpiry: 'Valid until',
            epLastChecked: 'Last checked',
            epNever: 'not checked yet',
            epReachable: 'Reachable',
            epUnreachable: 'Unreachable',
            epEmpty: 'No endpoints yet. Add a host:port to start monitoring.',
            epDelete: 'Delete',
            epSave: 'Save',
            epCancel: 'Cancel',
            epHostPlaceholder: 'example.com',
            epBack: 'Back to workspace',
        ...
        certificates: {
            ...
            bulkSkip: 'Skip monitoring',
            bulkUnskip: 'Resume monitoring',
            bulkAddTag: 'Add tag',
