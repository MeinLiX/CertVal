...
public record ToggleNotificationRuleCommand : IRequest<Result<NotificationRuleDto>>
{
    public Guid WorkspaceId { get; init; }
    public Guid RuleId { get; init; }
}

public class ToggleNotificationRuleCommandValidator : AbstractValidator<ToggleNotificationRuleCommand>
{
    public ToggleNotificationRuleCommandValidator()
    {
...
public class ToggleNotificationRuleCommandHandler : IRequestHandler<ToggleNotificationRuleCommand, Result<NotificationRuleDto>>
{
    private readonly IUnitOfWork _unitOfWork;
    private readonly ICurrentUserService _currentUser;

    public ToggleNotificationRuleCommandHandler(IUnitOfWork unitOfWork, ICurrentUserService currentUser)
    {
        _unitOfWork = unitOfWork;
        _currentUser = currentUser;
    }

    public async Task<Result<NotificationRuleDto>> Handle(ToggleNotificationRuleCommand request, CancellationToken cancellationToken)
    {
